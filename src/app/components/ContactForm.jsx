      ...
      <div className="container m-auto w-full flex mt-20">
        ...
        <form className="w-4/12 px-4" onSubmit={formik.handleSubmit}>
          <input
            ...
            className={`form-control w-full h-12 border-[1px] ${
              formik.touched.name && formik.errors.name
                ? "border-red-500"
                : "border-gray-600"
            } px-3 bg-transparent text-white`}
          ...
          <input
            ...
            className={`form-control w-full h-12 border-[1px] ${
              formik.touched.email && formik.errors.email
                ? "border-red-500"
                : "border-gray-600"
            } px-3 bg-transparent text-white my-5`}
          ...
          <textarea
            ...
            onChange={formik.handleChange}
            onBlur={formik.handleBlur}
            className={`form-control w-full border-[1px] ${
              formik.touched.message && formik.errors.message
                ? "border-red-500"
                : "border-gray-600"
            } px-3 pt-2 bg-transparent text-white my-5`}
            rows={5}
            placeholder="Message"
            required
          />
